...
<head>
    ...
    <title>Intro To Offensive Security</title>
        ...
        <div class="banner-container">
            <div class="banner">
                ...
                <div class="banner-text" style="padding-left: 40px;">
                    <h1>Introduction To Offensive Security</h1>
                    <p>Learn about the Introduction To Offensive Security.</p>
                </div>
            </div>
        </div>
        <div class="content">
            <div class="tasks">
                ...
                $sql = "SELECT * FROM tasks WHERE moduleId = 1 AND sectionId = 1"; // Change moduleId as needed
